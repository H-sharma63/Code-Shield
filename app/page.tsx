...
export default function Home() {
  ...
  const [isLoginCardVisible, setIsLoginCardVisible] = useState(false); // Add state for login card
  ...
  }, [session, user]); // Updated dependency array

  return (
    <>
      <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 bg-base">
        <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
          <div className="flex gap-4 items-center flex-col sm:flex-row">
            <button
              onClick={() => setIsLoginCardVisible(true)} // Change to button and add onClick
